...
<p align="center">
  <strong>专为应届毕业生量身打造的「企业大厂校招」与「体制内公考选调」双轨求职智能工作台。</strong><br>
  集多源情报雷达、构化解析、本地隐私脱敏沙箱、AI 契合度诊断、全流程投递看板与系统日历同步于一体。
</p>
...
<p><em>▲ CampusJob-Agent 核心作战仪表盘：多源校招信息渠道与招考趋势分析、72h 紧急 DDL 倒计时与意向匹配分析</em></p>
...
每年有超过 1,100 万高校毕业生面临毕业求职。当代应届生普遍面临「企业校招冲刺」与「体制内考公/选调」的两手准备，带来的是三大核心困境：

1. **信息碎片化与遗漏风险**：招聘信息散落在各高校就业网、微信公众号、大厂招聘官网及人事考试网中，人工整理耗时巨大，浪费宝贵的时间精力，多手抓抓不过来；
2. **门槛资格核查繁琐**：体制内选调与国企对专业代码目录、应届身份、政治面貌（党员）有强卡点，人工逐步核对工序繁琐；
3. **商业求职软件的隐私泄露担忧**：传统求职工具常要求把简历明文上传云端服务器，求职行踪与敏感信息（手机号、身份证、住址）存在被滥用甚至泄露的风险。

**CampusJob-Agent** 坚持 **Local-First（本地隐私优先）** 架构设计：所有求职数据存储在本地 SQLite；个人简历通过本地程序的规则匹配与沙箱混淆后，仅将脱敏摘要交给 LLM 推理交互；兼具 Agent 深度推演能力与隐私安全防护。
...
### 1. 📡 全域校招与招考雷达 (`/jobs`)
支持高校就业网 RSS、名企官网与事业单位招聘白名单聚合，支持按**城市、契合度阈值、仅应届、仅党员**组合交叉过滤，一键加入日程与排查资格。
...
覆盖 **已网申 ➔ 笔试阶段 ➔ 面试阶段 ➔ 体检/政审 ➔ 意向录用 (Offer)** 全流程。支持临界待办高亮、初筛入围率实时统计，并提供明细导出。
...
### 4. 🤖 AI 顾问与面试决策 (`/advisory`)
基于本地沙箱解析出的经历摘要，由 Agent 深度推演：
- **能力剖析**：专业背景匹配、项目工程落地、体制合规准入、面试表达达胜率、笔试应试储备与精力分配度；
- **名企针对性面试押题**：自动预测技术追问盲区（如 Raft/Paxos 状态机、分布式双写一致性等）；
- **公考资格匹配**：对照《普通高等学校本科/研究生专业目录》精准判定专业代码与选调准入资格。
...
- **免费基础版 (Free Tier)**：单一学校信源配置，面向广大应届生开箱即用，支持绑定本校就业网与主要官网，本地单机基础匹配与通告推送；
